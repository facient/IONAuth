...
<div class="page-content">
          <div class="header">
            <h4><strong>Cash Book</strong></h4>
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                <li><a href="/admin">Dashboard</a>
                </li>
                <li><a href="/admin/reports/cash_book">Cash Book</a>
                </li>
                    ...
                    <div class="col-sm-2">
                     ...
                     <div class="col-sm-2">
                      <div class="form-group">
                        ...
                        <br>
                        <button type="submit" id ="searchBtnCB" class="btn btn-embossed btn-primary">Search</button>
                      </div>
                    </div>
                  </div>
                </form>  
