          ...
          <div class="header">
            ...
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                ...
                <li><a href="/admin/payment">Payment</a>
                </li>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                 <a id="inputAddPayment" href="#Payment" data-toggle="modal">
                 <button type="button" class="btn btn-primary push-5-r push-10"><i class="fa fa-plus push-5-r"></i>Add Payment</button></a>
                             ...
                             if (isset($payments)): ?>
                                <?php foreach ($payments as $payment): ?>
                                    <tr id="rowdetail">
                                        ...
                                        <td><?php echo date('d/m/Y',strtotime($payment->date)).'&nbsp&nbsp&nbsp'; ?></td>                                        
                                         <td style="display:none;">
                                         <?php echo $payment->supplier_id; ?>
                                          
                                        </td>
                                        <td><?php echo $payment->supplier_name; ?></td>
                                        <td><?php echo $payment->description; ?></td>                                        
                                        <td><label class="label label-<?php echo ($payment->payment_mode=='bank')?'info':'success';?>"><?php echo $payment->payment_mode; ?></label></td>
                                        <td style="display:none;">
                                         <?php echo $payment->bank_id; ?>
                                        ...
                                        <td>
                                            <div class="btn-group">                                              
                                               <a href="#Payment" class="editpayment" data-toggle="modal"> 
...
<!--Start Add Payment Modal -->
       ...
       <?php $random= rand(1,99999); ?>
        <form action="/admin/payment/add" method="post" id="validateForm" class="form-validation form-horizontal" novalidate="novalidate">       
      ...
      <!--End Bank Tab  -->
        ...
        <div id="responseResult" class="col-lg-6">
          ...
          <div class="col-lg-6">
              ...
              Add Payment</button>
              <button id="inputEditPaymentButton" class="btn btn-md btn-primary" type="submit" style="display:none;">
