          ...
          <div class="header">
            ...
            <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                ...
                <li><a href="/admin/customer">Customer</a>
                </li>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                 ...
                 <button type="button" class="btn btn-primary push-5-r push-10"><i class="fa fa-plus push-5-r"></i>Add Customer</button></a>
               ...
               <div class="alert alert-danger flashdelete" style="display:none"></div>
                ...
                <div class="panel-content pagination2 table-responsive">
                  <table class="table table-hover" id="mydatatable1">
                    <thead>
                        <tr>
                            <th>S.No</th>
                            <th>Name</th>
                              ...
                              <?php $count=1; ?>
                                <?php foreach ($customers as $customer): ?>
                                    ...
                                    <tr id="editRow">
                                        ...
                                        <td>
                                        <a name="<?php echo $customer->id; ?>" href="customer"  class="label label-primary customerdet" 
                                        data-toggle="modal" >View Details</a></td>
                                        
                                        <td><?php echo $customer->email; ?></td>
                                        <td>
                                            <?php if ($customer->status=='Active'):?>
                                            <a class="singleStatus"  href="/admin/customer/status/<?php echo $customer->id ?>">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                               ...
                                               <a id="<?php echo $customer->id; ?>" class="editCustomer" data-toggle="modal" href="#addcustomer">
                                              <button class="btn btn-xs btn-primary" type="button" title="Edit Client">
                                               <i class="fa fa-pencil"></i></button></a>
                                             
                                               <a href="/admin/customer/delete/<?php echo $customer->id; ?>" class="singleDelete">
    ...
    <div class="modal-dialog modal-lg" role="dialog" >
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="myModalLabel" ><strong>Add Customer</strong></h4>
          <h4 class="modal-title" id="myEditModalLabel" style="display:none;"><strong>Edit Customer</strong></h4>
      </div>
      <div class="modal-body">
        <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
         <?php echo form_open('/admin/customer/add', ['id'=>'validateForm','class'=>'form-validation','novalidate'=>'novalidate']); ?>
          ...
          <div class="modal-footer">
              <div id="result"></div>
              <button class="btn btn-md btn-primary " type="" id="myAddButton">Add Customer</button>
              <button class="btn btn-md btn-primary" type="submit" id="myEditButton" style="display:none;">Update Customer</button>
